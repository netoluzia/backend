...
import { Category, InvoiceType, PrismaClient } from '@prisma/client'
import { generateHashes } from '../src/utils/invoice'
...
const services = [
  ...
  },
  {
    ...
    title: '75020048',
    description:
      'FACTOR REUMATOIDE, DOSEAMENTO COM DETERMINAÇÃO DO TIPO DE CADEIA PESDA( A,G E M)',
    net_price: 3998.4,
    category: 'LAB',
    discount: 0,
    type: 'service',
  ...
  },
  {
    ...
    title: '74030007',
    description:
      'Plasmódio(PESQUISA DE PASMÓDIUM) E IDENTIFICAÇÃO- TESTE IMUNOLOGICO DA MALÁRIA',
    net_price: 2499,
    category: 'LAB',
    discount: '',
    type: 'service',
  ...
  },
  {
    ...
    title: '99000040',
    description:
      'INJECÇÕES INTRAMUSCULAR( ADMINISTRAÇÃO DE MEDICAÇÃO IM), SD ( ADMINISTRAÇÃO DE MEDICAÇÃO SUBCUTÂNEA)',
    net_price: 1499.37,
    category: 'ENF',
    discount: '',
    type: 'service',
    ...
    data: services.map((item) => ({
      category:
        typeof item.category == 'object'
          ? (item.category.value as Category)
