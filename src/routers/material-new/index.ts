...
import { ExpendableMaterialRepository } from '../../repositories/material-new'
import { ExpendableMaterialController } from '../../controllers/material-new'
...
router.get('/index/:category', async (req: Request, res: Response) => {
  ...
  const repository = new ExpendableMaterialRepository()
  const controller = new ExpendableMaterialController(repository)
