...
exports.ExpendableMaterialController = void 0;
const global_interfaces_1 = require("../../types/global.interfaces");
const material_validator_1 = require("../../validator/material.validator");
class ExpendableMaterialController {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = material_validator_1.createExpendableMaterial.parse(payload);
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = material_validator_1.updateExpendableMaterial.parse(payload);
...
exports.ExpendableMaterialController = ExpendableMaterialController;
