...
exports.MongoDeleteInsuranceRepository = void 0;
const mongodb_1 = require("mongodb");
const mongo_1 = require("../../../database/mongo");
class MongoDeleteInsuranceRepository {
    deleteInsurance(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!deletedCount)
                throw new Error('Insurance was not found');
            const { _id } = insurance, rest = __rest(insurance, ["_id"]);
            return Object.assign({ id: _id.toHexString() }, rest);
        });
    }
}
exports.MongoDeleteInsuranceRepository = MongoDeleteInsuranceRepository;
