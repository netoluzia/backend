...
const service_new_1 = require("../../repositories/service-new");
const service_new_2 = require("../../controllers/service-new");
...
router.get('/index/:category', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const repository = new service_new_1.ServiceRepository();
    const controller = new service_new_2.ServiceController(repository);
