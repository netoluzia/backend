...
const insurance_validator_1 = require("../../validator/insurance.validator");
class InsuranceController {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = insurance_validator_1.createInsurance.parse(payload);
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = insurance_validator_1.updateInsurance.parse(payload);
