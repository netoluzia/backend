...
const payment_validator_1 = require("../../validator/payment.validator");
class PaymentController {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = payment_validator_1.createPayment.parse(payload);
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = payment_validator_1.updatePayment.parse(payload);
