...
const customer_validator_1 = require("../../validator/customer.validator");
class CustomerController {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = customer_validator_1.createCustomer.parse(payload);
    ...
    update(id, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payloadValidated = customer_validator_1.updateCustomer.parse(payload);
