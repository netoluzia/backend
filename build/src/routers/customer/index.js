...
const customer_1 = require("../../repositories/customer");
const customer_2 = require("../../controllers/customer");
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const repository = new customer_1.CustomerRepository();
    const controller = new customer_2.CustomerController(repository);
