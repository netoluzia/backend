...
const partner_1 = require("../../repositories/partner");
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const repository = new partner_1.PartnerRepository();
    const controller = new partner_2.PartnerController(repository);
