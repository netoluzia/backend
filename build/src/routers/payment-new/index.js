...
const payment_new_1 = require("../../repositories/payment-new");
const payment_new_2 = require("../../controllers/payment-new");
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const repository = new payment_new_1.PaymentRepository();
    const controller = new payment_new_2.PaymentController(repository);
